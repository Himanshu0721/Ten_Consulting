export const heroData = {
  ...
  breadcrumb: [
    ...
    { label: "AI-Innovation", link: "/ai-ml/generative-ai" },
  ],
  title: "AI-Innovation",
  description:
    "Unleashing the future with AI-transforming ideas into reality, driving creativity, and revolutionizing industries.",
};

export const contentData = {
  heading:
    "Unlocking infinite horizons: How AI-Innovation empowers industries with cutting-edge creativity, innovation, and inspiration.",
  paragraphs: [
...
export const justSectionDetails = {
  ...
  headerTitle: "Unlock AI's Full Potential",
  mainTitle: "Harness AI for Success",
...
export const justOfferings = [
  {
    ...
    content:
      "We design AI models tailored to your unique business needs, ensure seamless integration...",
  },
  {
    title: "💠 Advanced Training",
    content:
      "Our experts fine-tune AI models using real-world data, enhance accuracy and performan...",
  },
  {
    title: "💠 Seamless AI Integration",
    content:
      "We integrate AI-driven automation into your existing systems, improving productivit...",
  },
  {
    title: "💠 AI-Power Insights",
    content:
      "Gain deep business insights with AI-driven analytics, helping you make smarter and dat...",
  },
];

export const funFactDetails = {
  imageSrc:
    "https://d1ugv6dopk5bx0.cloudfront.net/s3fs-public/Purple%20(1).webp",
  iconSrc:
    "https://d3tj4wnms16o5e.cloudfront.net/s3fs-public/fun-fact-star.png",
  title: "AI FACT",
  fact: "AI-powered chatbots handle 85% of customer interactions, improving efficiency and satisfaction.",
  description:
    "Embrace AI-driven customer service and elevate engagement like never before.",
};
...
export const insightsData = [
  ...
  },
  {
    ...
    title:
      "Blockchain Beyond Cryptocurrency: The Future of Secure Transactions",
    date: "July 20, 2024",
  },
];
