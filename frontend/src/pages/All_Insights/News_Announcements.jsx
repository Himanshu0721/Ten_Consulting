    ...
    <div className="bg-gray-800 ">
      <div className="lg:px-20 md:px-10 px-4">
        ...
        <div className="w-full flex justify-center">
          <button className="text-gray-300 border-2 border-gray-300 hover:bg-gray-700 duration-200 rounded-md px-4 py-2 cursor-pointer mb-6" onClick={()=>setShowMoreBlog(!showMoreBlogs)}>{showMoreBlogs?"Show less blogs":"See more blogs"}</button>
        </div>
